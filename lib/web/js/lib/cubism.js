//modified: removed some metrics and comparison charts, added per-graph formats
(function(exports){
    var cubism = exports.cubism = {version: "nowl1.4.0"};
    var cubism_id = 0;
        ...
        function horizon(selection) {
            ...
            selection.each(function(d, i) {
                var that = this,
                    ...
                    format_ = typeof format === "function" ? d3.format(format.call(that, d, i)) : d3.format(format),
                    start = -Infinity,
                    step = context.step(),
                ...
                function focus(i) {
                    ...
                    span.datum(value).text(isNaN(value) ? null : format_);
                }
